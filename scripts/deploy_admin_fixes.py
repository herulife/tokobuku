...
def main():
    ...
    try:
        ...
        files = [
            ...
            ("d:/uma/cintabuku/frontend/src/components/admin/Sidebar.tsx", "/tmp/Sidebar.tsx"),
            ("d:/uma/cintabuku/frontend/src/app/admin/layout.tsx", "/tmp/AdminLayout.tsx")
        ]
        ...
        cmd_move = f"echo '{VPS_PASS}' | sudo -S bash -c 'mv /tmp/Navbar.tsx /home/ubuntu24/my-docker-apps/apps/cintabuku/frontend/src/components/Navbar.tsx && mv /tmp/Sidebar.tsx /home/ubuntu24/my-docker-apps/apps/cintabuku/frontend/src/components/admin/Sidebar.tsx && mv /tmp/AdminLayout.tsx /home/ubuntu24/my-docker-apps/apps/cintabuku/frontend/src/app/admin/layout.tsx'"
