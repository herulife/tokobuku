...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var apiKey, baseURL, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('--- Testing RajaOngkir API Key ---');
                    apiKey = 'EryXeiVR78e23652ad1e2f93giZZc37G';
                    baseURL = 'https://api.rajaongkir.com/starter';
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    // Test /city endpoint
                    console.log("Checking City endpoint: ".concat(baseURL, "/city?id=501")); // 501 is Yogyakarta
                    return [4 /*yield*/, axios_1.default.get("".concat(baseURL, "/city"), {
                            headers: { key: apiKey },
                            params: { id: 501 }
                        })];
                case 2:
