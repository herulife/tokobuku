...
exports.protect = (0, asyncHandler_1.asyncHandler)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                currentUser = _a.sent();
                if (!currentUser) {
                    return [2 /*return*/, next(new AppError_1.AppError('The user belonging to this token no longer does exist.', 401))];
                }
