...
function cleanupRajaOngkirSettings() {
    return __awaiter(this, void 0, void 0, function () {
        var rajaOngkirKeys, result, remaining, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    console.log("\u2705 ".concat(result.count, " settings RajaOngkir berhasil dihapus"));
                    return [4 /*yield*/, prisma.setting.findMany()];
                case 2:
                    remaining = _a.sent();
                    console.log('\n📋 Settings yang tersisa:');
                    remaining.forEach(function (s) {
                        console.log("   - ".concat(s.key, ": ").concat(s.value));
                    });
