...
function upgradeAdminsToSuperAdmin() {
    return __awaiter(this, void 0, void 0, function () {
        var result, users, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    console.log("\u2705 ".concat(result.count, " user berhasil diupgrade dari ADMIN \u2192 SUPER_ADMIN"));
                ...
                case 2:
                    ...
                    users.forEach(function (u) {
                        var emoji = u.role === 'SUPER_ADMIN' ? '👑' : u.role === 'ADMIN' ? '⚙️' : '👤';
                        console.log("   ".concat(emoji, " ").concat(u.name, " (").concat(u.email, ") - ").concat(u.role));
                    });
