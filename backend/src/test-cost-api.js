...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var apiKeySetting, token, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    apiKeySetting = _a.sent();
                    token = 'EryXeiVR78e23652ad1e2f93giZZc37G';
                    console.log('Using API Key:', token.substring(0, 10) + '...');
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, axios_1.default.get("https://api.binderbyte.com/v1/cost", {
