...
function promoteAdmin() {
    return __awaiter(this, void 0, void 0, function () {
        var email, password, hashedPassword, existingUser, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    console.log("User ".concat(email, " found. Promoting to ADMIN..."));
                ...
                case 4:
                    ...
                    return [3 /*break*/, 7];
                case 5:
                    console.log("User ".concat(email, " not found. Creating ADMIN user..."));
